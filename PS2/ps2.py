...
# Answer: objective function for this problem is to find the shortest path. Constraints are the distances
...
digraph = load_map(map_filename)
best = directed_dfs(digraph, 'a', 'e', 100, 30)
print("expected: ['a', 'b', 'e']")
print("received: " + str(best))